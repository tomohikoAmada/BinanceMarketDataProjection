...
// The canonical specs come from the shared M3 identity source
// (m3_workload_specs) so Phase-6 timing and Phase-7 allocation measurement
// carry bit-identical workload identities (OD-M5-P7-009/010).
// ---------------------------------------------------------------------------
namespace {
