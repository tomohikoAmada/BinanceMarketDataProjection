...
- Phase 7 status: **AUTHORIZED / NOT STARTED** — pre-implementation decision record
  PROPOSED / PENDING INDEPENDENT METHODOLOGY REVIEW on the immutable base
  `eed3de99efaba8eaa96083a5348d538ed44f6bfe`; see
  `docs/M5_PHASE7_PREIMPLEMENTATION_DECISIONS.md` (decisions OD-M5-P7-001 through
  OD-M5-P7-022). Implementation authorization is NO until the record is independently
