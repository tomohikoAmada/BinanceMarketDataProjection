...
function(bmd_projection_generate_benchmark_build_identity)
  ...
  if(Git_FOUND)
    ...
    if(NOT _git_sha_result EQUAL 0 OR BMD_P6_GIT_SHA STREQUAL "")
      set(BMD_P6_GIT_SHA "unavailable")
    endif()
    if(_git_status_result EQUAL 0 AND _git_status_output STREQUAL "")
      set(BMD_P6_GIT_DIRTY_AT_CONFIGURE "false")
    elseif(_git_status_result EQUAL 0)
